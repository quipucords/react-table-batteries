 ...
 */
export declare const useClientPaginationDerivedState: <TItem>(args: UseClientPaginationDerivedStateArgs<TItem>) => {
    currentPageItems: TItem[];
};
//# sourceMappingURL=useClientPaginationDerivedState.d.ts.map