 ...
 * @see PersistTarget
 */
export declare const useFilterState: <TItem, TFilterCategoryKey extends string, TPersistenceKeyPrefix extends string = string>(args: {
    filter?: FilterStateArgs<TItem, TFilterCategoryKey>;
} & TablePersistenceArgs<TPersistenceKeyPrefix>) => FilterState<TFilterCategoryKey>;
