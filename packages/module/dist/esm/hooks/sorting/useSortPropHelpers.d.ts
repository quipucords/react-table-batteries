 ...
 */
export interface UseSortPropHelpersExternalArgs<TItem, TColumnKey extends string, TSortableColumnKey extends TColumnKey> {
    /**
 ...
 */
export declare const useSortPropHelpers: <TItem, TColumnKey extends string, TSortableColumnKey extends TColumnKey>(args: UseSortPropHelpersExternalArgs<TItem, TColumnKey, TSortableColumnKey> & UseSortPropHelpersInternalArgs<TColumnKey>) => {
    getSortThProps: ({ columnKey }: {
        columnKey: TSortableColumnKey;
    }) => Pick<ThProps, "sort">;
};
//# sourceMappingURL=useSortPropHelpers.d.ts.map