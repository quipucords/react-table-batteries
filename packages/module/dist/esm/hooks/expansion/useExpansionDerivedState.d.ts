 ...
 */
export declare const useExpansionDerivedState: <TItem, TColumnKey extends string>(args: UseExpansionDerivedStateArgs<TItem, TColumnKey>) => ExpansionDerivedState<TItem, TColumnKey>;
//# sourceMappingURL=useExpansionDerivedState.d.ts.map