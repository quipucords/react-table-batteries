 ...
 */
export declare const useActiveItemDerivedState: <TItem>(args: UseActiveItemDerivedStateArgs<TItem>) => ActiveItemDerivedState<TItem>;
//# sourceMappingURL=useActiveItemDerivedState.d.ts.map