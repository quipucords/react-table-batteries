...
import { UseClientFilterDerivedStateArgs, UseFilterPropHelpersExternalArgs, FilterState, FilterStateArgs } from './hooks/filtering';
import { UseClientSortDerivedStateArgs, UseSortPropHelpersExternalArgs, SortState, SortStateArgs } from './hooks/sorting';
import { UseClientPaginationDerivedStateArgs, UsePaginationPropHelpersExternalArgs, PaginationState, PaginationStateArgs } from './hooks/pagination';
import { SelectionDerivedState, SelectionState, SelectionStateArgs, UseSelectionPropHelpersExternalArgs } from './hooks/selection';
import { ExpansionDerivedState, ExpansionState, ExpansionStateArgs } from './hooks/expansion';
import { ActiveItemDerivedState, UseActiveItemPropHelpersExternalArgs, ActiveItemState, ActiveItemStateArgs } from './hooks/active-item';
...
import { TdWithBatteriesProps, ThWithBatteriesProps, ToolbarBulkSelectorWithBatteriesProps, TrWithBatteriesBodyRowProps, TrWithBatteriesHeaderRowProps } from './components';
export type ItemId = string | number;
/**
 * Identifier for a feature of the table. State concerns are separated by feature.
 */
export declare const TABLE_FEATURES: readonly ["filter", "sort", "pagination", "selection", "expansion", "activeItem"];
 ...
 */
export interface TableFeatureStateArgs<TItem, TColumnKey extends string, TSortableColumnKey extends TColumnKey, TFilterCategoryKey extends string = string> {
    /**
 ...
 */
export interface TableFeatureState<TColumnKey extends string, TSortableColumnKey extends TColumnKey, TFilterCategoryKey extends string = string> {
 ...
 * @see TableBatteries
 */
export interface TableState<TItem, TColumnKey extends string, TSortableColumnKey extends TColumnKey, TFilterCategoryKey extends string = string, TPersistenceKeyPrefix extends string = string> extends MergedArgs<UseTableStateArgs<TItem, TColumnKey, TSortableColumnKey, TFilterCategoryKey, TPersistenceKeyPrefix>, TableFeatureState<TColumnKey, TSortableColumnKey, TFilterCategoryKey>> {
    /**
 ...
 */
export type UseClientTableDerivedStateArgs<TItem, TColumnKey extends string, TSortableColumnKey extends TColumnKey, TFilterCategoryKey extends string = string> = UseClientFilterDerivedStateArgs<TItem, TFilterCategoryKey> & UseClientSortDerivedStateArgs<TItem, TSortableColumnKey> & UseClientPaginationDerivedStateArgs<TItem>;
/**
...
export type PropHelpersFeatureExternalArgs<TItem, TColumnKey extends string, TSortableColumnKey extends TColumnKey, TFilterCategoryKey extends string> = UseFilterPropHelpersExternalArgs<TItem, TFilterCategoryKey> & UseSortPropHelpersExternalArgs<TItem, TColumnKey, TSortableColumnKey> & UsePaginationPropHelpersExternalArgs & UseSelectionPropHelpersExternalArgs<TItem> & UseExpansionPropHelpersExternalArgs<TItem, TColumnKey> & UseActiveItemPropHelpersExternalArgs<TItem>;
/**
 ...
 * @see TableBatteries
 */
export type UseTablePropHelpersArgs<TItem, TColumnKey extends string, TSortableColumnKey extends TColumnKey, TFilterCategoryKey extends string = string, TPersistenceKeyPrefix extends string = string> = MergedArgs<MergedArgs<UseTableStateArgs<TItem, TColumnKey, TSortableColumnKey, TFilterCategoryKey, TPersistenceKeyPrefix>, TableState<TItem, TColumnKey, TSortableColumnKey, TFilterCategoryKey, TPersistenceKeyPrefix>>, PropHelpersFeatureExternalArgs<TItem, TColumnKey, TSortableColumnKey, TFilterCategoryKey>> & TableDerivedState<TItem> & {
    /**
 ...
 */
export type TableBatteries<TItem, TColumnKey extends string, TSortableColumnKey extends TColumnKey, TFilterCategoryKey extends string = string, TPersistenceKeyPrefix extends string = string> = MergedArgs<MergedArgs<TableState<TItem, TColumnKey, TSortableColumnKey, TFilterCategoryKey, TPersistenceKeyPrefix>, UseTablePropHelpersArgs<TItem, TColumnKey, TSortableColumnKey, TFilterCategoryKey, TPersistenceKeyPrefix>>, Partial<TableFeatureDerivedState<TItem, TColumnKey>>> & {
    /**
    ...
    propHelpers: {
        ...
        getTdProps: (args: {
            columnKey: TColumnKey;
        } & DiscriminatedArgs<'isCompoundExpandToggle', {
            item: TItem;
            rowIndex: number;
        }>) => Omit<TdProps, 'ref'>;
        /**
    ...
    components: {
         ...
         */
        Tr: React.ForwardRefExoticComponent<Omit<TrWithBatteriesHeaderRowProps, 'ref'> | Omit<TrWithBatteriesBodyRowProps<TItem>, 'ref'>>;
        /**
 ...
 */
export type UseClientTableBatteriesArgs<TItem, TColumnKey extends string, TSortableColumnKey extends TColumnKey, TFilterCategoryKey extends string = string, TPersistenceKeyPrefix extends string = string> = UseTableStateArgs<TItem, TColumnKey, TSortableColumnKey, TFilterCategoryKey, TPersistenceKeyPrefix> & Omit<UseClientTableDerivedStateArgs<TItem, TColumnKey, TSortableColumnKey, TFilterCategoryKey>, TableFeature> & Omit<UseTablePropHelpersArgs<TItem, TColumnKey, TSortableColumnKey, TFilterCategoryKey, TPersistenceKeyPrefix>, TableFeature | keyof TableDerivedState<TItem> | keyof TableState<TItem, TColumnKey, TSortableColumnKey, TFilterCategoryKey, TPersistenceKeyPrefix>> & Partial<{
    [key in TableFeature]: Omit<(key extends 'filter' | 'sort' | 'pagination' ? UseClientTableDerivedStateArgs<TItem, TColumnKey, TSortableColumnKey, TFilterCategoryKey>[key] : unknown) & UseTablePropHelpersArgs<TItem, TColumnKey, TSortableColumnKey, TFilterCategoryKey>[key], keyof TableState<TItem, TColumnKey, TSortableColumnKey, TFilterCategoryKey, TPersistenceKeyPrefix>[key]>;
}>;
